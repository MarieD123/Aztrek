...
<header class="header-top" id="top"
    ...
    <?php if ($pays["libelle"][0] === "A" || $pays["libelle"][0] === "E" || $pays["libelle"][0] === "I" || $pays["libelle"][0] === "O" || $pays["libelle"][0] === "U" || $pays["libelle"][0] === "Y"  || $pays["libelle"][0] === "É") : ?>
        <h1>Découvrez l'<?= $pays["libelle"]; ?></h1>
    <?php else: ?>
