...
$ingredients = getAllIngredientsByRecette($id);
...
?>
    ...
    <main class="container">
        ...
        <section class="row">
            <div class="col-md-4">
                <img src="uploads/<?= $recipe["image"]; ?>" alt="<?= $recipe["titre"]; ?>" class="img-responsive">
            </div>
            <div class="col-md-4">
                <h1><?= $recipe["titre"]; ?></h1>
                <p>
            ...
            <div class="col-md-4">
                ...
                <ul>
                    ...
                    <li><?= $ingredient["qte"]." ".$ingredient["unite"]." ".$ingredient["libelle"]; ?></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </section>
